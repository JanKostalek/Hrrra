(function () {
  ...
  function Player(spawnX, spawnY) {
    ...
    this.jumpHoldTime = 0;
    this.currentJumpGravity = C.singleJumpGravity;
    this.currentJumpInitialVelocity = C.singleJumpInitialVelocity;
    this.currentJumpHoldAcceleration = C.singleJumpHoldAcceleration;
    this.currentJumpHoldMaxTime = C.singleJumpHoldMaxTime;
